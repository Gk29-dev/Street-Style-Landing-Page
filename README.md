...
- In this project, I build street style landing page.

- I learned, position property of css.

- I learned, how to use different font-family in a project.

- I learned, border-radius property of buttons

***

### Checkout the webiste : [Click Here](https://street-landing.netlify.app/)
